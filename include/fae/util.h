...
#define midi_message_t      fae_midi_message_t
...
#define midi_message(s,a,b) fae_midi_message_create_simple(s,a,b)
#define midi_message_sysex(b) fae_midi_message_create_sysex(b)
