...
fae_signal_t fae_signal_lift3(fae_ternary_t,
                              ...
                              fae_signal_t,
                              fae_signal_t);
fae_signal_t fae_signal_apply(fae_processor_t, fae_signal_t);
fae_signal_t fae_signal_apply2(fae_processor_t,
                               fae_signal_t,
                               fae_signal_t);
fae_signal_t fae_signal_apply3(fae_processor_t,
                               fae_signal_t,
                               fae_signal_t,
                               fae_signal_t);
fae_signal_t fae_signal_constant(fae_ptr_t);
fae_signal_t fae_signal_value(fae_event_t);
...
fae_signal_t fae_signal_absolute(fae_signal_t);
fae_signal_t fae_signal_not(fae_signal_t);
...
fae_signal_t fae_signal_greater_than_equal(fae_signal_t,
                                           fae_signal_t);
fae_signal_t fae_signal_acos(fae_signal_t);
fae_signal_t fae_signal_asin(fae_signal_t);
fae_signal_t fae_signal_atan(fae_signal_t);
fae_signal_t fae_signal_cos(fae_signal_t);
fae_signal_t fae_signal_sin(fae_signal_t);
fae_signal_t fae_signal_tan(fae_signal_t);
fae_signal_t fae_signal_exp(fae_signal_t);
fae_signal_t fae_signal_log(fae_signal_t);
fae_signal_t fae_signal_log10(fae_signal_t);
fae_signal_t fae_signal_pow(fae_signal_t);
fae_signal_t fae_signal_sqrt(fae_signal_t);
fae_signal_t fae_signal_abs(fae_signal_t);
fae_signal_t fae_signal_min(fae_signal_t);
fae_signal_t fae_signal_max(fae_signal_t);
fae_signal_t fae_signal_fmod(fae_signal_t);
fae_signal_t fae_signal_remainder(fae_signal_t);
fae_signal_t fae_signal_floor(fae_signal_t);
fae_signal_t fae_signal_ceil(fae_signal_t);
fae_signal_t fae_signal_rint(fae_signal_t);
