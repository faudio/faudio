...
typedef doremir_ptr_t doremir_atomic_value_t;
typedef doremir_atomic_value_t (* doremir_atomic_updater_t)(doremir_atomic_value_t);
...
void doremir_atomic_set(doremir_atomic_t, doremir_atomic_value_t);
