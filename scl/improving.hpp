  ...
  namespace detail
  {
    namespace improving
    {
      ...
      */
      ...
      {
        return improving<T>(
                 ::scl::detail::improving::min<T>(x.state, y.state));
      }
      ...
      {
        return improving<T>(
                 ::scl::detail::improving::max<T>(x.state, y.state));
      }
      ...
      {
        return improving<T>(
                 ::scl::detail::improving::operator+ <T>(x.state, y.state));
      }
...
namespace scl
{
  using detail::improving::improving;
  using detail::improving::accumulator;
  using detail::improving::min;
  using detail::improving::max;
  using detail::improving::operator+;
  using detail::improving::operator-;
  using detail::improving::operator*;
  using detail::improving::operator/;
  using detail::improving::operator<;
