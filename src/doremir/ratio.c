                                  ...
                                  doremir_ratio_t y)
{
    ...
    return doremir_ratio_create( a*d + b*c, b*d );
}
                                       ...
                                       doremir_ratio_t y)
{
    ...
    return doremir_ratio_create( a*c, b*d );
}
                                     ...
                                     doremir_ratio_t y)
{
    ...
    return doremir_ratio_create( a*d, b*c );
}

doremir_ratio_t doremir_ratio_succ(doremir_ratio_t x)
{
    return doremir_ratio_add(x, doremir_ratio_create(1,1));
}

doremir_ratio_t doremir_ratio_pred(doremir_ratio_t x)
{
    return doremir_ratio_subtract(x, doremir_ratio_create(1,1));
}

doremir_ratio_t doremir_ratio_negate(doremir_ratio_t x)
{
    return doremir_ratio_multiply(x, doremir_ratio_create(-1,1));
}

doremir_ratio_t doremir_ratio_recip(doremir_ratio_t x)
{
    return doremir_ratio_divide(doremir_ratio_create(1,1), x);
}
