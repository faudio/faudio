 ...
 */
doremir_processor_t doremir_processor_unary(doremir_type_t type1,
                                                doremir_type_t type2,
                                                doremir_unary_t function)
{
    return (doremir_processor_t) doremir_processor_unary_create(type1, type2, function);
}

doremir_processor_t doremir_processor_binary(doremir_type_t type1,
                                                 doremir_type_t type2,
...
doremir_processor_t doremir_processor_constant(doremir_type_t type1,
                                                   doremir_type_t type2,
                                                   doremir_ptr_t value)
{
    assert(false && "Not implemented");
...
#define WRAP_UNARY(F) \
    doremir_processor_t doremir_processor_##F(doremir_type_t type1, doremir_type_t type2) \
    {                                                                  \
