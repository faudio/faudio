...
(defcfun (action-null "fa_action_null") action)
...
(defcfun (action-repeat "fa_action_repeat") action (a time) (b action))
(defcfun (action-many "fa_action_many") action (a list))
(defcfun (action-if "fa_action_if") action (a pred) (b ptr) (c action))
(defcfun (action-while "fa_action_while") action (a pred) (b ptr) (c action))
(defcfun (action-until "fa_action_until") action (a pred) (b ptr) (c action))
(defcfun (action-do "fa_action_do") action (a nullary) (b ptr))
(defcfun (action-is-simple "fa_action_is_simple") :boolean (a action))
(defcfun (action-is-compound "fa_action_is_compound") :boolean (a action))
(defcfun (action-compound-interval "fa_action_compound_interval") time (a action))
(defcfun (action-compound-first "fa_action_compound_first") action (a action))
(defcfun (action-compound-rest "fa_action_compound_rest") action (a action))
