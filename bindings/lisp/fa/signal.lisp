...
(defcfun (signal-acos "fa_signal_acos") signal (a signal) (b signal))
(defcfun (signal-asin "fa_signal_asin") signal (a signal) (b signal))
(defcfun (signal-atan "fa_signal_atan") signal (a signal) (b signal))
(defcfun (signal-cos "fa_signal_cos") signal (a signal))
(defcfun (signal-sin "fa_signal_sin") signal (a signal))
(defcfun (signal-tan "fa_signal_tan") signal (a signal) (b signal))
(defcfun (signal-exp "fa_signal_exp") signal (a signal) (b signal))
(defcfun (signal-log "fa_signal_log") signal (a signal) (b signal))
(defcfun (signal-log10 "fa_signal_log10") signal (a signal) (b signal))
