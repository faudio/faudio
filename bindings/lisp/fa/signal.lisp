...
(defcfun (signal-custom "fa_signal_custom") signal (a (:pointer signal-custom-processor)) (b signal))
...
(defctype signal-stream-input-callback (:pointer (:pointer :void)))
(defctype signal-stream-output-callback (:pointer (:pointer :void)))
(defcfun (signal-input-stream "fa_signal_input_stream") signal (a :int) (b signal-stream-input-callback) (c ptr))
(defcfun (signal-output-stream "fa_signal_output_stream") signal (a :int) (b signal-stream-output-callback) (c ptr) (d signal))
