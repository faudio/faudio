...
(defcfun (buffer-create "fa_buffer_create") buffer (a :int32))
...
(defcfun (buffer-set "fa_buffer_set") :void (a buffer) (b :int32) (c :uint8))
(defcfun (buffer-get-int16 "fa_buffer_get_int16") :int16 (a buffer) (b :int32))
(defcfun (buffer-get-int32 "fa_buffer_get_int32") :int32 (a buffer) (b :int32))
(defcfun (buffer-get-int64 "fa_buffer_get_int64") :int64 (a buffer) (b :int32))
(defcfun (buffer-get-float "fa_buffer_get_float") :float (a buffer) (b :int32))
(defcfun (buffer-get-double "fa_buffer_get_double") :double (a buffer) (b :int32))
(defcfun (buffer-set-int16 "fa_buffer_set_int16") :void (a buffer) (b :int32) (c :int16))
(defcfun (buffer-set-int32 "fa_buffer_set_int32") :void (a buffer) (b :int32) (c :int32))
(defcfun (buffer-set-int64 "fa_buffer_set_int64") :void (a buffer) (b :int32) (c :int64))
(defcfun (buffer-set-float "fa_buffer_set_float") :void (a buffer) (b :int32) (c :float))
(defcfun (buffer-set-double "fa_buffer_set_double") :void (a buffer) (b :int32) (c :double))
