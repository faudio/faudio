...
(defcfun "Doremir.Map.single" :Doremir.Map (:Doremir.Map.Key :Doremir.Ptr))
...
(defcfun "Doremir.Map.elem" :boolean (:Doremir.Map :Doremir.Ptr))
...
(defcfun "Doremir.Map.add" :Doremir.Map (:Doremir.Map :Doremir.Map.Key :Doremir.Ptr))

(defcfun "Doremir.Map.remove" :void (:Doremir.Map :Doremir.Map.Key :Doremir.Ptr))

(defcfun "Doremir.Map.addDest" :Doremir.Map (:Doremir.Map :Doremir.Map.Key :Doremir.Ptr))

(defcfun "Doremir.Map.removeDest" :void (:Doremir.Map :Doremir.Map.Key :Doremir.Ptr))