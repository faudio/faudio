...
(defcfun (graph-connect "doremir_graph_connect") graph (a graph-node) (b graph-node) (c graph-edge) (d graph))
(defcfun (graph-disconnect "doremir_graph_disconnect") graph (a graph-node) (b graph-node) (c graph))
(defcfun (graph-to-dot "doremir_graph_to_dot") string (a string) (b string) (c graph))
