...
(defcfun (time-time "doremir_time_time") time (a ptr))
(defcfun (time-tick-rate "doremir_time_tick_rate") :double (a ptr))
(defcfun (time-ticks "doremir_time_ticks") :int64 (a ptr))
