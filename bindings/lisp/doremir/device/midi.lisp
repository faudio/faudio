...
(defcfun (device-midi-with-session "doremir_device_midi_with_session") :void (a device-midi-session-callback) (b ptr) (c error-callback) (d ptr))
...
(defcfun (device-midi-default-input "doremir_device_midi_default_input") device-midi (a device-midi-session))
(defcfun (device-midi-default-output "doremir_device_midi_default_output") device-midi (a device-midi-session))
(defcfun (device-midi-set-status-callback "doremir_device_midi_set_status_callback") :void (a device-midi-status-callback) (b ptr) (c device-midi-session))
...
(defcfun (device-midi-open-stream "doremir_device_midi_open_stream") device-midi-stream (a device-midi))
(defcfun (device-midi-close-stream "doremir_device_midi_close_stream") :void (a device-midi-stream))
(defcfun (device-midi-with-stream "doremir_device_midi_with_stream") :void (a device-midi) (b device-midi-stream-callback) (c ptr) (d error-callback) (e ptr))