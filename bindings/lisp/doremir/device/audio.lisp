...
(defcfun (device-audio-with-session "doremir_device_audio_with_session") :void (a device-audio-session-callback) (b ptr) (c error-callback) (d ptr))
...
(defcfun (device-audio-with-stream "doremir_device_audio_with_stream") :void (a device-audio) (b processor) (c device-audio) (d device-audio-stream-callback) (e ptr) (f error-callback) (g ptr))