...
(defcfun (message-send "doremir_message_send") :void (a message-receiver) (b message-address) (c message))
(defcfun (message-receive "doremir_message_receive") list (a message-sender) (b message-address))
(defcfun (message-sync "doremir_message_sync") :void (a message-sender))
