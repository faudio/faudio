...
(defcfun (message-send "doremir_message_send") :void (a message-dispatcher) (b message-address) (c message))
(defcfun (message-sync "doremir_message_sync") :void (a message-dispatcher))
(defcfun (message-receive "doremir_message_receive") list (a message-dispatcher) (b message-address))