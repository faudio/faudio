...
(defcfun (list-join-map "doremir_list_join_map") list (a unary) (b ptr) (c list))
(defcfun (list-djoin-map "doremir_list_djoin_map") list (a unary) (b ptr) (c list))
(defcfun (list-join "doremir_list_join") list (a list))
(defcfun (list-djoin "doremir_list_djoin") list (a list))
