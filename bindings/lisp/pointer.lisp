...
#+win32 (defcfun (is-bool#      "fa_is_bool") (:boolean :unsigned-char) (a :pointer))
#+win32 (defcfun (is-int8#      "fa_is_int8") (:boolean :unsigned-char) (a :pointer))
#+win32 (defcfun (is-int16#     "fa_is_int16") (:boolean :unsigned-char) (a :pointer))
#+win32 (defcfun (is-int32#     "fa_is_int32") (:boolean :unsigned-char) (a :pointer))
#+win32 (defcfun (is-int64#     "fa_is_int64") (:boolean :unsigned-char) (a :pointer))
#+win32 (defcfun (is-float#     "fa_is_float") (:boolean :unsigned-char) (a :pointer))
#+win32 (defcfun (is-double#    "fa_is_double") (:boolean :unsigned-char) (a :pointer))
#+win32 (defcfun (is-dynamic#   "fa_dynamic_check") (:boolean :unsigned-char) (a :pointer))
#+win32 (defcfun (is-ref#       "fa_is_ref") (:boolean :unsigned-char) (a :pointer))

#-win32 (defcfun (is-bool#      "fa_is_bool") :boolean (a :pointer))
#-win32 (defcfun (is-int8#      "fa_is_int8") :boolean (a :pointer))
#-win32 (defcfun (is-int16#     "fa_is_int16") :boolean (a :pointer))
#-win32 (defcfun (is-int32#     "fa_is_int32") :boolean (a :pointer))
#-win32 (defcfun (is-int64#     "fa_is_int64") :boolean (a :pointer))
#-win32 (defcfun (is-float#     "fa_is_float") :boolean (a :pointer))
#-win32 (defcfun (is-double#    "fa_is_double") :boolean (a :pointer))
#-win32 (defcfun (is-dynamic#   "fa_dynamic_check") :boolean (a :pointer))
#-win32 (defcfun (is-ref#       "fa_is_ref") :boolean (a :pointer))


#+win32(defcfun (to-bool#      "fa_to_bool") (:boolean :unsigned-char) (a :pointer))
#-win32(defcfun (to-bool#      "fa_to_bool") :boolean (a :pointer))
...
#+win32(defcfun (peek-bool#    "fa_peek_bool") (:boolean :unsigned-char) (a :pointer))
#-win32(defcfun (peek-bool#    "fa_peek_bool") :boolean (a :pointer))
...
#+win32(defcfun (from-bool#    "fa_from_bool") :pointer (a (:boolean :unsigned-char)))
#-win32(defcfun (from-bool#    "fa_from_bool") :pointer (a :boolean))
