...
static fa_ptr_t before_(fa_ptr_t x, int count, fa_signal_state_t *state)
{
...
static fa_ptr_t after_(fa_ptr_t x, int count, fa_signal_state_t *state)
{
    // Nothing
    return NULL;
}
...
static fa_ptr_t render_(fa_ptr_t x, int offset, int count, fa_signal_state_t *state)
{
    fluid_context *context = x;
    fluid_synth_t *synth = context->synth;
...
static fa_ptr_t destroy_(fa_ptr_t x)
{
    fluid_context *context = x;
    if (context->owned) {
